...
class LiberarMesa():
    ...
    def mostrarAyuda(self, event):
        mensaje_ayuda = (
            "Ayuda:\n\n"
            "1. ID de Mesa: Ingrese el número de identificación de la mesa que desea liberar.\n"
            ...
            "5. Salir: Cierra la ventana de liberación de mesa.\n"
            "6. Estado: El estado de la mesa (ocupada, libre, etc.) se muestra tras realizar la búsqueda.\n"
            "7. Cantidad Comensales: Muestra el número de comensales para la mesa seleccionada."
        )
    ...
    def __init__(self, usuario):
        ...
        self.btnLiberar = tk.Button(self.ventana, text="Liberar", image=self.iconoOcupar, width=85, state="disabled", compound="left")
